...
export const ChatItem = ({
    ...
    const onMemberClick = () => {
        ...
        router.push(`/servers/${params?.serverId}/conversations/${member.id}`);(`/servers/${params?.serverId}/conversations/${member.id}`);
    }
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isPDF && (
                        <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
                            <FileIcon className="h-10 w-10 fill-sky-200 stroke-indigo-400"/>
                            <a 
                            href={fileUrl}
                            target="_blank"
                            rel="noopener noreferrer"
